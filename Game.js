...
play () {
  ...
  for ( var plr in allPlayers) {
    ...
    index = index + 1;
      ...
      //use formed data the database, to display the cars in a and y directions
  ...
  if (index === player.index) {
    ...
    //Chaning camera position in y direction
...
showleaderboard() {
  var leader1, leader2;
  var players = Object.values(alPlayers);
  if(
    (players[0].rank ===> + || players[0].rank === 0)
      player[0].rank === 1. 
